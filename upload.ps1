$folderPath = "C:\Users\aymar\Documents\Godot\Projects\ShroomJam2025\shroom-jam-2025\Build"
...
$butlerCommand = "butler push `"$zipFilePath`" laurenoutang/duckbuster:html5"
